...
router.add_api_view("webpage-list", url(r'^webpages/$', views_d.WebpageList.as_view(), name='webpage-list'))
router.add_api_view("webpage-detail", url(r'^webpages/(?P<pk>[0-9]+)/$', views_d.WebpageDetail.as_view(), name='webpage-detail'))
